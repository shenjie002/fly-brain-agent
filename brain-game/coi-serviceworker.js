...
// 让 GitHub Pages 等无法自定义响应头的静态托管也能启用 SharedArrayBuffer：
// 一个 service worker 拦截同源响应，注入 COOP/COEP 头（cross-origin isolation）。
// MuJoCo WASM 依赖 SharedArrayBuffer，因此本站点必须 cross-origin isolated。
